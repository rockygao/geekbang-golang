...
import (
	...
	pb "go_code/geekbang-golang/Week4/api/v1/proto"
	"go_code/geekbang-golang/Week4/internal/data"
	model "go_code/geekbang-golang/Week4/internal/model"
	biz "wgo_code/geekbang-golang/Week4/internal/biz"
...
func (server *GrpcServer) Register(ctx context.Context, req *pb.RegisterRequest) (*pb.Response, error) {
	...
	if err != nil {
		if errors.Is(err, data.ErrAleadyExit) {
			return &pb.Response{
				Code:    400,
